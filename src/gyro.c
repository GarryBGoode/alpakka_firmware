...
void Gyro__config_x(Gyro *self, float min, float max, Actions neg, Actions pos, float sens) {
...
void Gyro__config_y(Gyro *self, float min, float max, Actions neg, Actions pos, float sens) {
...
void Gyro__config_z(Gyro *self, float min, float max, Actions neg, Actions pos, float sens) {
